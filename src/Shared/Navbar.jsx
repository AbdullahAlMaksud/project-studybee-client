...
const Navbar = () => {
    ...
    const mobileMainMenu = <>
        ...
        <div className="flex flex-col my-3 gap-3">
            ...
            <NavLink to={'/'} className={({ isActive }) => isActive ? 'bg-blue-950 text-white py-1 rounded-sm pl-2' : 'hover:bg-gray-800 hover:text-white py-1 rounded-sm pl-2'}>Manage Service</NavLink>
